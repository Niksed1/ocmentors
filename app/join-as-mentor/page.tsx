      ...
      <main className="flex-1">
        <div className="w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="mb-12">
            ...
            <div className="bg-white/10 rounded-lg p-6 sm:p-8">
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <p className="text-white/80">Strong expertise in STEM subjects (Math, Science, Engineering, Technology)</p>
                </li>
                <li className="flex items-start gap-3">
                  <div className="flex-shrink-0 w-6 h-6 rounded-full bg-primary-green text-white flex items-center justify-center text-sm font-bold mt-0.5">
                    ✓
                  </div>
                  <p className="text-white/80">Excellent communication and teaching skills</p>
                </li>
                <li className="flex items-start gap-3">
                  <div className="flex-shrink-0 w-6 h-6 rounded-full bg-primary-green text-white flex items-center justify-center text-sm font-bold mt-0.5">
                    ✓
                  </div>
                  <p className="text-white/80">Patience and ability to guide students step-by-step</p>
                </li>
                <li className="flex items-start gap-3">
                  <div className="flex-shrink-0 w-6 h-6 rounded-full bg-primary-green text-white flex items-center justify-center text-sm font-bold mt-0.5">
                    ✓
                  </div>
                  <p className="text-white/80">Commitment to helping students learn and grow independently</p>
                </li>
                <li className="flex items-start gap-3">
                  <div className="flex-shrink-0 w-6 h-6 rounded-full bg-primary-green text-white flex items-center justify-center text-sm font-bold mt-0.5">
                    ✓
                  </div>
                  <p className="text-white/80">Reliable internet connection and suitable environment for online sessions</p>
                </li>
              </ul>
            </div>
          </div>
