      ...
      <main className="flex-1">
        <div className="w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="mb-12">
            ...
            <p className="text-xl text-dark-purple/80 text-center mb-8">
              It is everything you can think of
            </p>
            <div className="grid sm:grid-cols-2 gap-4 max-w-3xl mx-auto">
              <div className="flex items-start gap-3 p-4 bg-light-gray/30 rounded-lg">
                ...
                <p className="text-dark-purple/80">1 on 1 specialized tutoring</p>
              </div>
              <div className="flex items-start gap-3 p-4 bg-light-gray/30 rounded-lg">
                <div className="flex-shrink-0 w-6 h-6 rounded-full bg-primary-green text-white flex items-center justify-center text-sm font-bold mt-0.5">
                  ✓
                </div>
                <p className="text-dark-purple/80">Weekly sessions (3-4x)</p>
              </div>
              <div className="flex items-start gap-3 p-4 bg-light-gray/30 rounded-lg">
                <div className="flex-shrink-0 w-6 h-6 rounded-full bg-primary-green text-white flex items-center justify-center text-sm font-bold mt-0.5">
                  ✓
                </div>
                <p className="text-dark-purple/80">Engaging study guides</p>
              </div>
              <div className="flex items-start gap-3 p-4 bg-light-gray/30 rounded-lg">
                <div className="flex-shrink-0 w-6 h-6 rounded-full bg-primary-green text-white flex items-center justify-center text-sm font-bold mt-0.5">
                  ✓
                </div>
                <p className="text-dark-purple/80">Recorded course videos that are tailored to help you with your classes</p>
              </div>
            </div>
          </div>
          ...
          {/* Mission Statement */}
          <div className="mb-12">
            <p className="text-lg text-dark-purple/80 text-center mb-8">
          ...
          <div className="space-y-8 mb-16">
            {/* Method 1 */}
            <div className="bg-light-gray/50 rounded-lg p-6 sm:p-8 border-l-4 border-primary-green">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h3 className="text-2xl font-semibold text-dark-purple mb-3">
            ...
            {/* Method 3 */}
            <div className="bg-light-gray/50 rounded-lg p-6 sm:p-8 border-l-4 border-accent-green">
              <div className="flex items-start gap-4">
                <div className="flex-shrink-0 w-12 h-12 rounded-full bg-accent-green text-dark-purple flex items-center justify-center text-xl font-bold">
                  3
                </div>
                <div className="flex-1">
                  <h3 className="text-2xl font-semibold text-dark-purple mb-3">
          ...
          <div className="text-center bg-primary-green/10 rounded-lg p-8 border-2 border-primary-green/20">
            <p className="text-2xl font-semibold text-dark-purple">
