...
export default function Footer() {
  return (
    <footer className="border-t border-white/20 mt-auto" style={{ backgroundColor: '#0F172A' }}>
      <div className="mx-auto max-w-7xl px-2 sm:px-3 py-8">
        <div className="flex flex-col gap-6">
          ...
          {/* Legal Links */}
          <div className="flex flex-wrap items-center justify-center gap-4 text-sm text-white/60 border-t border-white/10 pt-4">
            <Link
              href="/imprint"
